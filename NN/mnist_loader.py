...
def load_data():
    ...
    The first entry contains the actual training images, The is a numpy ndarray 50,000 entries. Each entry is, in turn, a
    ...
    This is a nice data format, but for use in neural networks in neural networks it's
